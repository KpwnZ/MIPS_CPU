...
#
# Generated by export_simulation on Fri Dec 18 01:20:15 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './ins_rom.sh' script.

./ins_rom.sh -reset_run
...
./ins_rom.sh -noclean_files

For more information on the script, please type './ins_rom.sh -help'.
